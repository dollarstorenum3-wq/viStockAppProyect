...
export default function FormularioAgregarCategoria({
  nuevaCategoria,
  manejoCambio,
  guardarCategoria,
  visible = false,
    ...
    >
      <View style={styles.contenedor}>
        <View style={styles.modalcontenedor}>
          <Text style={styles.titulomodal}>Agregar nueva Categoría</Text>
            ...
            onChangeText={(nombre_categoria)=>manejoCambio("nombre_categoria", nombre_categoria)}/>
              ...
              <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={guardarCategoria}>
