...
export default function FormularioAgregarMarca({
  nuevaMarca,
  manejoCambio,
  guardarMarca,
  visible = false,
    ...
    >
      <View style={styles.contenedor}>
        <View style={styles.modalcontenedor}>
          <Text style={styles.titulomodal}>Agregar nueva Marca</Text>
            ...
            onChangeText={(nombre_marca)=>manejoCambio("nombre_marca", nombre_marca)}/>
              ...
              <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={guardarMarca}>
